<x-guest-layout>
    <form method="POST" action="{{ route('password.store') }}">
        ...
        <div>
            ...
            <x-text-input style="background-color:white" id="email" class="block mt-1 w-full" type="email"
        ...
        <div class="mt-4">
            ...
            <x-text-input style="background-color:white" id="password" class="block mt-1 w-full" type="password"
        ...
        <div class="mt-4">
            ...
            <x-text-input style="background-color:white" id="password_confirmation" class="block mt-1 w-full"
